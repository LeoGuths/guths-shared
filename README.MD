...
### 2. Configuração com Políticas de Autorização Customizadas
...
### 4. Configurações via AWS Parameter Store
...
OBS: O valor padrão de todos os parâmetros abaixo é `true`.
```text
